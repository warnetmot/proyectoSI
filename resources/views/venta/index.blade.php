            ...
            <table id="datatablesSimple" class="table table-striped">
                <thead>
                    <tr>
                        ...
                        <th>Cliente</th>
                        <th>Vendedor</th>
                        <th>Producto</th> <!-- Columna de Producto -->
                        <th>Cantidad</th> <!-- Columna de Cantidad -->
                        <th>Total</th>
                        <th>Fecha y hora</th> <!-- Columna de Fecha -->
                        <th>Acciones</th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            @foreach($item->productos as $producto) <!-- Mostrar nombre del producto -->
                                <p class="mb-0">{{ $producto->nombre }}</p>
                            @endforeach
                        </td>
                        <td>
                            @foreach($item->productos as $producto) <!-- Mostrar cantidad de cada producto -->
                                <p class="mb-0">{{ $producto->pivot->cantidad }}</p>
                            @endforeach
                        </td>
                        <td>
                            {{$item->total}}
