...
<div class="container-fluid px-4">
    <h1 class="mt-4 text-center">Editar Categoría: {{ $categoria->caracteristica->nombre }}</h1>
        ...
        <div class="card-body">
            <form action="{{ route('categorias.update',['categoria'=>$categoria]) }}" method="post">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-12">
                        ...
                        <textarea name="descripcion" id="descripcion" rows="3" 
                                  ...
                                  placeholder="Describa las características de esta categoría">{{ old('descripcion', $categoria->caracteristica->descripcion) }}</textarea>
                        @error('descripcion')
                        <div class="invalid-feedback">
                            <i class="fas fa-exclamation-circle me-1"></i>{{ $message }}
                        </div>
                ...
                <div class="d-flex justify-content-between mt-4">
                    <a href="{{ route('categorias.index') }}" class="btn btn-secondary-custom">
