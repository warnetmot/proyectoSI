...
<div class="container-fluid px-4">
    <h1 class="mt-4 text-center">Crear Nueva Categoría</h1>
    ...
    <div class="card shadow-sm">
        <div class="card-header-custom p-3">
            <h5 class="mb-0"><i class="fas fa-tag me-2"></i>Información de la Categoría</h5>
        </div>
        <div class="card-body">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="nombre" id="nombre" 
                               ...
                               value="{{ old('nombre') }}"
                               placeholder="Ej: telefonos, tablest.">
                        @error('nombre')
                    ...
                    <div class="col-12">
                        ...
                        <textarea name="descripcion" id="descripcion" rows="3" 
                                  ...
                                  placeholder="Describa las características de esta categoría">{{ old('descripcion') }}</textarea>
                        @error('descripcion')
                        <div class="invalid-feedback d-block">
                            <i class="fas fa-exclamation-circle me-1"></i>{{ $message }}
                        </div>
