    ...
    <div class="card shadow-sm mb-4">
        <div class="card-header card-header-custom">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <a href="{{ route('clientes.index') }}" class="btn btn-sm btn-outline-light">
                ...
                <div class="row mb-3">
                    <div class="col-12">
                        <div class="d-flex align-items-center">
                            <span class="me-2">Tipo de cliente:</span>
                            <span class="badge client-type-badge {{ $cliente->persona->tipo_persona }} rounded-pill text-white">
                                {{ strtoupper($cliente->persona->tipo_persona) == 'NATURAL' ? 'PERSONA NATURAL' : 'PERSONA JURÍDICA' }}
                            </span>
                        </div>
                    </div>
                </div>
                ...
                <div class="row g-3 mb-4">
                    ...
                    <div class="col-12">
                        ...
                        <input required type="text" name="razon_social" id="razon_social" 
                               ...
                               placeholder="{{ $cliente->persona->tipo_persona == 'natural' ? 'Ej: Juan Pérez López' : 'Ej: Empresa XYZ S.A.C.' }}">
                        @error('razon_social')
