...
<div class="container-fluid px-4">
    <h1 class="mt-4 text-center">Gestión de Clientes</h1>
    ...
    <div class="card shadow-sm">
        <div class="card-header card-header-custom p-3">
            <div class="d-flex justify-content-between align-items-center">
                <h5 class="mb-0"><i class="fas fa-users me-2"></i>Listado de Clientes</h5>
                <div class="dropdown">
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <p>{{ $item->persona->estado == 1 ? '¿Está seguro que desea desactivar este cliente?' : '¿Está seguro que desea reactivar este cliente?' }}</p>
                                        <p class="small text-muted">{{ $item->persona->estado == 1 ? 'El cliente no podrá realizar nuevas compras.' : 'El cliente podrá volver a realizar compras.' }}</p>
                                    </div>
