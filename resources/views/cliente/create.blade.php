...
<div class="container-fluid px-4">
    <h1 class="mt-4 text-center">Crear Nuevo Cliente</h1>
    ...
    <div class="card shadow-sm mb-4">
        <div class="card-header card-header-custom">
            <div class="d-flex justify-content-between align-items-center">
                <h5 class="mb-0"><i class="fas fa-user-plus me-2"></i>Registro de Cliente</h5>
                ...
                <div class="row g-3 mb-4">
                    ...
                    <div class="col-12" id="box-razon-social">
                        ...
                        <input required type="text" name="razon_social" id="razon_social" 
                               ...
                               placeholder="Ingrese los datos según el tipo de cliente">
                        @error('razon_social')
                            <div class="error-message text-danger">{{ '*'.$message }}</div>
                        @enderror
                    </div>
