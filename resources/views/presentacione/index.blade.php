...
<div class="container-fluid px-4">
    <h1 class="mt-4 text-center">Gestión de Presentaciones</h1>
    ...
    <div class="mb-4">
        <a href="{{route('presentaciones.create')}}">
            <button type="button" class="btn btn-primary-custom">
                <i class="fas fa-plus-circle me-2"></i> Nueva Presentación
            </button>
        </a>
    </div>
    @endcan
    ...
    <div class="card shadow-sm">
        <div class="card-header-custom p-3">
            <div class="d-flex justify-content-between align-items-center">
                <h5 class="mb-0"><i class="fas fa-box-open me-2"></i>Listado de Presentaciones</h5>
                <div class="dropdown">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex justify-content-center gap-2">
                                    ...
                                    <a href="{{route('presentaciones.edit',['presentacione'=>$item])}}" class="btn btn-sm btn-outline-primary btn-icon" title="Editar">
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <p>{{ $item->caracteristica->estado == 1 ? '¿Está seguro que desea desactivar la presentación "' : '¿Está seguro que desea reactivar la presentación "' }}{{ $item->caracteristica->nombre }}"?</p>
    ...
    document.addEventListener("DOMContentLoaded", function() {
        const dataTable = new simpleDatatables.DataTable("#datatablesSimple", {
            ...
            labels: {
                ...
                noRows: "No se encontraron presentaciones",
                info: "Mostrando {start} a {end} de {rows} presentaciones",
            },
            columns: [
