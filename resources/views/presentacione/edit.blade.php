...
<div class="container-fluid px-4">
    <h1 class="mt-4 text-center">Editar Presentación: {{ $presentacione->caracteristica->nombre }}</h1>
        ...
        <div class="card-body">
            <form action="{{ route('presentaciones.update',['presentacione'=>$presentacione]) }}" method="post">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-12">
                        ...
                        <textarea name="descripcion" id="descripcion" rows="3" 
                                  ...
                                  placeholder="Describa las características de esta presentación">{{ old('descripcion', $presentacione->caracteristica->descripcion) }}</textarea>
                        @error('descripcion')
                        <div class="invalid-feedback">
                            <i class="fas fa-exclamation-circle me-1"></i>{{ $message }}
                        </div>
                ...
                <div class="d-flex justify-content-between mt-4">
                    ...
                    <div>
                        <button type="reset" class="btn btn-secondary-custom me-2">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        // Auto-enfoque en el campo nombre al cargar
        document.getElementById('nombre').focus();
        
        // Mostrar valores originales al hacer clic en reiniciar
        const originalValues = {
            nombre: "{{ $presentacione->caracteristica->nombre }}",
            descripcion: "{{ $presentacione->caracteristica->descripcion }}"
        };
