...
class proveedorController extends Controller
{
    ...
    public function toggle(Persona $proveedore)
{
    // Cambiar estado: si está activo (1), lo desactiva (0); si está inactivo (0), lo activa (1).
    $proveedore->estado = $proveedore->estado == 1 ? 0 : 1;
    $proveedore->save();

    return redirect()->route('proveedores.index')->with('success', 'El estado del proveedor se ha actualizado correctamente.');
}
