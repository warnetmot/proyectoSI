...
class compraController extends Controller
{
    ...
    {
        // Recuperar la compra que se desea editar
        $compra = Compra::with('productos', 'proveedore.persona', 'comprobante')
                        ->findOrFail($id);
        
        // Recuperar los proveedores activos
        $proveedores = Proveedore::whereHas('persona', function ($query) {
            $query->where('estado', 1);
        })->get();
        
        // Recuperar todos los comprobantes
        $comprobantes = Comprobante::all();
        ...
        return view('compra.edit', compact('compra', 'proveedores', 'comprobantes', 'productos'));
    }
